export const categories = [
  { name: "Weights", count: 112, active: false },
  { name: "Barbells", count: 32, active: false },
  { name: "Conditioning", count: 42, active: false },
  { name: "Crossfit", count: 65, active: true },
  { name: "Accessories", count: 13, active: false },
];
